...
const Section2 = () => {
    ...
    return (
        <div id='work' className='2xl:h-[70vh] [@media(max-height:635px)]:h-[110vh] h-[80vh] flex justify-center'>
            <div className='max-sm:m-3 relative container sm:max-[1190px]:mx-9 max-w-[1111px] h-full max-h-[511px]'>
                ...
                <div className='hidden h-[70%] p-7 w-full  sm:flex'>
                    <div className='w-[70%]'>
                        ...
                        <ItemBadge text={`${t('badge1S2')}`} color={'#A7D910'}/>
                        <ItemBadge text={`${t('badge2S2')}`} color={'#FFFFFF'}/>
                        <ItemBadge text={`${t('badge3S2')}`} color={'#2FA2E3'}/>
                        <ItemBadge text={`${t('badge4S2')}`} color={'#9874F5'}/>
                        </div>
